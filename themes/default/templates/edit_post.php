<div class="editor-container font-standard">
    <div class="card editor-card">
        ...
        <form action="<?= $baseUrl ?>/post/edit/<?= (int)$postId ?>" method="POST" id="edit-post-form">
            <!-- WYSIWYG Toolbar -->
            ...
            <div class="form-group" style="position: relative;">
                <label for="reply-textarea">Post Body</label>
                <textarea id="reply-textarea" name="body" class="form-control" rows="10" placeholder="Write your post here... (Safe HTML & Image paste enabled)" required><?= htmlspecialchars($post['body']) ?></textarea>
